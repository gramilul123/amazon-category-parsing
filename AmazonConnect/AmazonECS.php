...
class AmazonECS
{
     ...
     * @see returnType()
     */
    public function search($pattern, $nodeId = null, $params = array())
    {
        ...
        if (!empty($params['amazon_search'])) {
            $base_params['Title'] = $params['amazon_search'];
        }
        if (!empty($params['amazon_min_price']) && $params['amazon_min_price'] != '0.00') {
            $params['amazon_min_price'] = str_replace(',', '', $params['amazon_min_price']);
            $base_params['MinimumPrice'] = $params['amazon_min_price'] * 100;
        }
        if (!empty($params['amazon_max_price']) && $params['amazon_max_price'] != '0.00') {
            $params['amazon_max_price'] = str_replace(',', '', $params['amazon_max_price']);
            $base_params['MaximumPrice'] = $params['amazon_max_price'] * 100;
        }
